...
const SECTIONS: Section[] = [
  ...
  },
  {
    ...
    items: [
      { icon: 'mic', color: colors.accent, title: 'Two commands, and you pick by what you say', body: '\u201cHey Siri, Log expense\u201d is one-way \u2014 Siri takes it, repeats it back, and the app never opens. \u201cHey Siri, Add expense\u201d is two-way \u2014 BudgetSplit opens with everything already filled in so you can split it or change something before saving. Set both up once in Settings \u2192 Voice entry. There is also the microphone on your keyboard on the Add screen, which needs no setup at all.' },
      ...
      { icon: 'users', color: colors.coral, title: 'Splitting by voice', body: 'Use the two-way command and BudgetSplit opens on the Add screen with the group list already showing, because who shares a cost and how is a decision only you can make. If a shared-sounding phrase goes through the one-way command instead \u2014 saying split, group, with or owe, or naming one of your groups by name \u2014 it is held in Review rather than filed as yours alone.' },
