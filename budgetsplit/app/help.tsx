...
const SECTIONS: Section[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { icon: 'alert-triangle', color: colors.expense, title: 'Overspending', body: 'If Cash available goes negative, the app automatically pulls from Want goals first, then Need, to cover it, and shows a notice with Undo. Emergency and Locked goals — and your assets — are never touched.' },
  ...
  },
  {
    ...
    items: [
      ...
      { icon: 'download', color: colors.income, title: 'Backups \u2014 a file you keep', body: 'Settings \u2192 Backup makes one encrypted file of everything and hands it to you, to keep in Files, iCloud Drive or wherever you like. It is yours, separate from your account. It is encrypted on this phone with a passphrase that is never sent anywhere \u2014 which also means a forgotten passphrase cannot be reset by anyone, including us. Restoring replaces everything on this phone with the file, so it asks first.' },
      ...
      { icon: 'user-plus', color: colors.accent, title: 'Sharing a group with someone', body: 'Open the group \u2192 Members \u2192 Invite someone, and pick a person linked to your account \u2014 link them first under Settings \u2192 Linked people. They get an invitation and nothing is shared until they accept it \u2014 being added to a group should not be something that happens to you.' },
  ...
  },
  {
    ...
    items: [
      { icon: 'wifi-off', color: colors.income, title: 'Local by default', body: 'No account is needed to use the app, and there is no tracking and no analytics. Without an account, your money lives only on this device. Two things can leave it: receipt scanning sends that one photo to a cloud text-reader (you can switch that off), and signing in keeps a copy of everything on your account, readable by our server, so a new phone gets it back. See \u201cAccount, backup and sync\u201d above for what each one does.' },
