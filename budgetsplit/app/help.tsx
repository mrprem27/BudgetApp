...
const SECTIONS: Section[] = [
  ...
  },
  {
    ...
    items: [
      { icon: 'mic', color: colors.accent, title: 'Three commands, and none of them opens the app', body: '\u201cHey Siri, Log expense\u201d for spending, \u201cLog income\u201d for money in, \u201cSettle up\u201d for paying someone back. All three work the same way: Siri asks, you answer, it tells you what it did, and you carry on \u2014 BudgetSplit never comes to the front. Which command you say is how it knows the kind, so that part is never guessed from your words. Set them up once in Settings \u2192 Voice entry. There is also the microphone on your keyboard on the Add screen, which needs no setup at all.' },
      ...
      { icon: 'zap', color: colors.income, title: 'What happens when the app is closed', body: 'The shortcut says what it did \u2014 \u201cSaved in BudgetSplit\u201d, or \u201cWaiting in Review\u201d \u2014 so you know it heard you, and then you carry on with whatever you were doing. The phrase waits on your phone and is filed the next time you open BudgetSplit, including just switching back to it. Your balance does not move until then.' },
